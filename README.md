...
![структура общего сверточного перемежителя](image.png)
...
![Блок, описанный мной](my_block_1.jpg) ![Блок, Simulink](block_simulink_1.png)
...
Результаты сигналов, полученные из моего блока и блока Simulink, описанные в виде графиков:
![Блок, описанный мной](my_block_2.jpg) ![Блок, Simulink](block_simulink_2.png)